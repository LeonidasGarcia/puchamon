...
from ...modules.battle.domain.entities import Battle, BattleInstance
...
async def init_db():
    ...
    try:
        ...
        await init_beanie(
            database=database, document_models=[Condition, MoveEffect, Movement, Moveset, Pokemon, Type, Weather, Battle, BattleInstance]
        )
